      ...
      <div className='lg:grid xl:grid-cols-5'>
        <div className='pr-3 xl:pt-6 xl:col-span-3 hover:-translate-y-8 duration-500'>
          <div data-aos="fade-left"
            ...
            <p className="font-bellefair text-xl md:text-3xl font-thin text-zinc-300 mt-4">The concept of this project is to create a single page web application, this project reflects the concept of react router and describes my skills about react and react router to create a conceptual project.</p>
      ...
      <div className='lg:grid xl:grid-cols-5'>
        ...
        <div className='hover:-translate-y-8 duration-500 text-right pl-3 col-span-3'>
          <div data-aos="fade-right"
            ...
            <p className="text-xl font-bellefair md:text-3xl font-thin text-zinc-300 mt-4">My portfolio website is a comprehensive showcase of my skills and works, It is designed and developed with a user friendly interface and clean, professional look to provide a smooth browsing experience for visitors.The website is built using React - js, Tailwind - CSS and other library, which describes my knowladge and understanding of the web teachnology.</p>
