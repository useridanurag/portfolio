    ...
    <RoundedContainer >
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 lg:flex gap-6'>
        <div className='text-zinc-300 lg:mr-16'>
          ...
          <div className="flex jusitfy-center allign-center pb-2 md:pb-3 hover:text-white">
            <div><GoLocation className="text-2xl pb-1 sm:text-3xl lg:mt-1" /></div>
            <p className="font-light text-sm pl-2 sm:inline sm:pl-4 sm:text-lg md:text-xl lg:text-2xl hover:translate-x-2 duration-300"># 117, Hausing Board colony, Bhatoli khurd, Baddi Phase 5, Dist - Solan, Himachal Pradesh - 173205 (India).</p>
          </div>
          <br />
